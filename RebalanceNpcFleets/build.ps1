# Builds Restitutor_Rebalance_NpcFleets.dll, runs rule checks, installs to Mods\Rebalance.
...
dotnet build "$here\Restitutor_Rebalance_NpcFleets.csproj" -c Release -p:NuGetAudit=false
...
$dll="$here\bin\Release\net6.0\Restitutor_Rebalance_NpcFleets.dll"
...
Get-FileHash "$out\Restitutor_Rebalance_NpcFleets.dll","$dest\Restitutor_Rebalance_NpcFleets.dll" -Algorithm SHA256 | Format-List
