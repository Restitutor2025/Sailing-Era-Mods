...
namespace Il2CppClient.UILogic.UISailReady
{
    ...
    public class PlayerData { public PortDB PlayerPort = new(); public LaneDB PlayerLaneData=new(); }
    public class Port { public bool NoLineReach = true, MeasureCanReach = true; }
    public class Model
    {
        public object? Measurer = new();
        public int HarbourID = 10, Dirty, SelectAreaIndex, TargetDays;
        public Dictionary<int, Port> TotalPortDic = new();
        public void MarkDirty() => Dirty++;
    }
    public partial class UISailLineCtrl : Il2CppCore.NewUISystem.IUIBaseCtrl
    {
    ...
    public partial class SailLineManager : TestSupport.NativeObject
    {
