...
Check(mod.HarmonyInstance.Unpatched == 0 && mod.LoggerInstance.Lines.Count == 1 && mod.LoggerInstance.Lines[0].StartsWith("MSG 0.1.1 (Restitutor.Core " + Restitutor.Core.CoreInfo.Version + ")"));
...
namespace HarmonyLib {
 ...
 public class Harmony { public Harmony() {} public Harmony(string id) {} public readonly List<(MethodBase o, HarmonyMethod? pre, HarmonyMethod? post, HarmonyMethod? fin)> Patches = new(); public int Unpatched;
