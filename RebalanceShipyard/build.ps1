# Builds Restitutor_Rebalance_Shipyard.dll, runs rule checks, installs to Mods\Rebalance.
...
dotnet build "$here\Restitutor_Rebalance_Shipyard.csproj" -c Release -p:NuGetAudit=false
...
$dll="$here\bin\Release\net6.0\Restitutor_Rebalance_Shipyard.dll"
...
Get-FileHash "$out\Restitutor_Rebalance_Shipyard.dll","$dest\Restitutor_Rebalance_Shipyard.dll" -Algorithm SHA256 | Format-List
