...
- 소스 `src/` (Rules.cs = 순수 규칙, EntryPoint.cs = Postfix 8개 + 입력 1개, Nav.cs = 포커스·Q/E 페이지·페이지 줄), 검사 `tests/`.
- 빌드·설치: 게임 종료 후 `powershell -NoProfile -ExecutionPolicy Bypass -File build.ps1` → `Mods\Rebalance\`.
- 문서: `docs/mods/rebalance-saveslots/0.2.5.md`(현재), `0.2.4.md`, `0.2.3.md`, `0.2.2.md`, `0.2.1.md`, `0.2.0.md`, `0.1.1.md`, `0.1.0.md`.
