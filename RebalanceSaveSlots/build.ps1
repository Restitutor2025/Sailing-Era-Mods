# Builds Restitutor_Rebalance_SaveSlots.dll, runs rule checks, installs to Mods\Rebalance.
...
dotnet build "$here\Restitutor_Rebalance_SaveSlots.csproj" -c Release -p:NuGetAudit=false
...
$dll="$here\bin\Release\net6.0\Restitutor_Rebalance_SaveSlots.dll"
...
Get-FileHash "$out\Restitutor_Rebalance_SaveSlots.dll","$dest\Restitutor_Rebalance_SaveSlots.dll" -Algorithm SHA256 | Format-List
